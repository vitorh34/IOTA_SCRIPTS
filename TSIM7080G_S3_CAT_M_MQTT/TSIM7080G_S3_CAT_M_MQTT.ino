...
const char apn[] = "lf.br";
const char gprsUser[] = "";
const char gprsPass[] = "";

// IOTA server address and port
const char server[]   = "iota.vimacsolucoes.com.br";
const int  port       = 1883;
char buffer[1024] = {0};

// Copy the <MQTT USERNAME> <MQTT PASSWORD> <CLIENT ID> field to the bottom for replacement
char username[] = "vimac";
char password[] = "8c894cec-c7a1-492a-9603-3679e09b7c0f";
char clientID[] = "8c894cec-c7a1-492a-9603-3679e09b7c0f";
char topic[] = "vimac/8c894cec-c7a1-492a-9603-3679e09b7c0f";
